...
window.originalQuestions = Object.freeze([
  ...
  { id: "EI_E1", text: "예배가 끝나고 아는 얼굴이 보이면 먼저 다가가 인사한다.", axis: "EI", side: "E" },
  ...
  { id: "EI_I2", text: "마음이 답답할 때는 말로 꺼내기 전에 혼자 있는 시간이 필요하다.", axis: "EI", side: "I" },

  { id: "EI_E3", text: "교회에 가면 사람들 만나는 게 반갑고 즐겁다.", axis: "EI", side: "E" },
  { id: "EI_I3", text: "교회에서는 사람들과 어울리는 것보다 조용히 예배드리는 시간이 더 좋다.", axis: "EI", side: "I" },

  { id: "EI_E4", text: "신앙에 대해 궁금한 게 생기면 누군가에게 물어보고 싶다.", axis: "EI", side: "E" },
  { id: "EI_I4", text: "신앙에 대해 궁금한 게 생기면 혼자 찾아보는 편이다.", axis: "EI", side: "I" },

  { id: "EI_E5", text: "처음 보는 사람들 사이에서 말이 끊기면 내가 먼저 말을 꺼낸다.", axis: "EI", side: "E" },
  { id: "EI_I5", text: "처음 보는 사람들 사이에서는 말을 안 해도 별로 불편하지 않다.", axis: "EI", side: "I" },

  // S / N — 무엇을 통해 하나님과 삶을 받아들이는가
  { id: "SN_S1", text: "설교를 들으면 ‘이번 주에 뭘 해야 하지?’부터 생각난다.", axis: "SN", side: "S" },
  { id: "SN_N1", text: "설교를 들으면 ‘이 말씀이 무슨 뜻일까’를 오래 생각하게 된다.", axis: "SN", side: "N" },

  { id: "SN_S2", text: "기도한 일이 실제로 풀리는 걸 볼 때 하나님이 함께하신다고 느낀다.", axis: "SN", side: "S" },
  { id: "SN_N2", text: "상황은 그대로여도 마음이 편해질 때 하나님이 함께하신다고 느낀다.", axis: "SN", side: "N" },

  { id: "SN_S3", text: "성경을 읽으면 그때 실제로 어떤 일이 있었는지가 궁금하다.", axis: "SN", side: "S" },
  { id: "SN_N3", text: "성경을 읽으면 이 이야기가 지금 나한테 무슨 말을 하는지가 궁금하다.", axis: "SN", side: "N" },

  { id: "SN_S4", text: "믿음이 자랐다는 건 내 행동이 달라진 걸 보고 알 수 있다.", axis: "SN", side: "S" },
  { id: "SN_N4", text: "믿음이 자랐다는 건 남들은 몰라도 내 마음이 달라진 걸로 알 수 있다.", axis: "SN", side: "N" },

  { id: "SN_S5", text: "기도할 때 필요한 것을 하나씩 구체적으로 말하는 편이다.", axis: "SN", side: "S" },
  { id: "SN_N5", text: "기도할 때 말이 잘 안 나와도 마음만 쏟아놓게 되는 편이다.", axis: "SN", side: "N" },

  // T / F — 무엇을 기준으로 판단하는가
  { id: "TF_T1", text: "힘들다는 이야기를 들으면 어떻게 하면 나아질지부터 생각한다.", axis: "TF", side: "T" },
  { id: "TF_F1", text: "힘들다는 이야기를 들으면 그 사람 마음이 어땠을지부터 생각난다.", axis: "TF", side: "F" },

  { id: "TF_T2", text: "교회에서 뭔가 결정되면 ‘왜 그렇게 정했지?’부터 알고 싶다.", axis: "TF", side: "T" },
  { id: "TF_F2", text: "교회에서 뭔가 결정되면 서운해할 사람이 없을지부터 신경 쓰인다.", axis: "TF", side: "F" },

  { id: "TF_T3", text: "설교를 듣다가 앞뒤가 안 맞는 말이 나오면 계속 신경 쓰인다.", axis: "TF", side: "T" },
  { id: "TF_F3", text: "설교가 마음에 와닿으면 자세한 내용은 별로 따지지 않게 된다.", axis: "TF", side: "F" },

  { id: "TF_T4", text: "믿음이 흔들릴 때 납득할 만한 설명을 찾아보게 된다.", axis: "TF", side: "T" },
  { id: "TF_F4", text: "믿음이 흔들릴 때 누군가의 솔직한 경험담에 마음이 풀린다.", axis: "TF", side: "F" },

  { id: "TF_T5", text: "부탁을 받으면 내가 할 수 있는 일인지부터 따져본다.", axis: "TF", side: "T" },
  { id: "TF_F5", text: "부탁을 받으면 거절했을 때 상대가 서운해할까 봐 걱정된다.", axis: "TF", side: "F" },

  // J / P — 삶을 어떤 방식으로 꾸려 가는가
  { id: "JP_J1", text: "기도나 성경 읽기는 시간을 정해두고 하는 게 나에게 맞다.", axis: "JP", side: "J" },
  { id: "JP_P1", text: "기도나 성경 읽기는 마음이 생길 때 하는 게 나에게 맞다.", axis: "JP", side: "P" },

  { id: "JP_J2", text: "주일은 늘 하던 순서대로 흘러가는 게 마음이 편하다.", axis: "JP", side: "J" },
  { id: "JP_P2", text: "주일 일정이 그날그날 달라져도 별로 신경 쓰이지 않는다.", axis: "JP", side: "P" },

  { id: "JP_J3", text: "뭔가 하기로 마음먹으면 언제 할지 정해둬야 마음이 놓인다.", axis: "JP", side: "J" },
  { id: "JP_P3", text: "뭔가 하기로 마음먹어도 그때그때 상황을 봐 가며 하는 게 편하다.", axis: "JP", side: "P" },

  { id: "JP_J4", text: "약속이 갑자기 바뀌면 마음을 다시 잡는 데 시간이 걸린다.", axis: "JP", side: "J" },
  { id: "JP_P4", text: "약속이 갑자기 바뀌어도 ‘그럴 수도 있지’ 하고 금방 넘어간다.", axis: "JP", side: "P" },

  { id: "JP_J5", text: "한 해를 돌아볼 때 마음먹은 걸 얼마나 지켰는지 따져보게 된다.", axis: "JP", side: "J" },
  { id: "JP_P5", text: "한 해를 돌아볼 때 어떤 일들이 있었는지 하나씩 떠올려 보게 된다.", axis: "JP", side: "P" },
]);
