...
window.originalQuestions = Object.freeze([
  // E / I — 마음의 에너지가 어디로 흐르는가
  { id: "EI_E1", text: "예배가 끝나고 아는 얼굴이 보이면 먼저 다가가 인사를 건네는 편이다.", axis: "EI", side: "E" },
  { id: "EI_I1", text: "예배가 끝나면 인사를 길게 나누기보다 조용히 자리를 뜨는 게 편하다.", axis: "EI", side: "I" },

  { id: "EI_E2", text: "마음이 답답할 때 누군가에게 털어놓고 나면 한결 가벼워진다.", axis: "EI", side: "E" },
  { id: "EI_I2", text: "마음이 답답할 때는 말로 꺼내기 전에 혼자 정리하는 시간이 필요하다.", axis: "EI", side: "I" },

  { id: "EI_E3", text: "교회에 가는 이유 중에는 사람들을 만나는 즐거움도 꽤 큰 자리를 차지한다.", axis: "EI", side: "E" },
  { id: "EI_I3", text: "교회에서는 사람을 많이 만나는 것보다 조용히 예배드리는 시간이 더 좋다.", axis: "EI", side: "I" },

  { id: "EI_E4", text: "신앙에 대해 궁금한 게 생기면 누군가에게 물어보며 이야기를 나누고 싶다.", axis: "EI", side: "E" },
  { id: "EI_I4", text: "신앙에 대해 궁금한 게 생기면 혼자 찾아보고 생각하며 정리하는 편이다.", axis: "EI", side: "I" },

  { id: "EI_E5", text: "처음 보는 사람들 사이에서 말이 끊기면 내가 먼저 말을 꺼내게 된다.", axis: "EI", side: "E" },
  { id: "EI_I5", text: "처음 보는 사람들 사이에서는 굳이 말을 보태지 않아도 크게 불편하지 않다.", axis: "EI", side: "I" },

  // S / N — 무엇을 통해 하나님과 삶을 받아들이는가
  { id: "SN_S1", text: "설교를 들으면 ‘그래서 이번 주에 뭘 해보라는 걸까’가 가장 궁금하다.", axis: "SN", side: "S" },
  { id: "SN_N1", text: "설교를 들으면 ‘이 말씀이 결국 무슨 뜻일까’를 오래 곱씹게 된다.", axis: "SN", side: "N" },

  { id: "SN_S2", text: "하나님이 함께하신다고 느낄 때는 실제로 상황이 풀리는 걸 볼 때가 많다.", axis: "SN", side: "S" },
  { id: "SN_N2", text: "하나님이 함께하신다고 느낄 때는 설명하기 어려운 마음의 확신이 들 때가 많다.", axis: "SN", side: "N" },

  { id: "SN_S3", text: "성경을 읽을 때 그 시대에 실제로 어떤 일이 있었는지가 궁금해진다.", axis: "SN", side: "S" },
  { id: "SN_N3", text: "성경을 읽을 때 이 이야기가 지금 나에게 무엇을 말하는지가 궁금해진다.", axis: "SN", side: "N" },

  { id: "SN_S4", text: "신앙이 자란다는 건 나에게 눈에 보이는 변화가 생기는 것에 가깝다고 느낀다.", axis: "SN", side: "S" },
  { id: "SN_N4", text: "신앙이 자란다는 건 겉으로 안 보여도 마음의 깊이가 달라지는 것에 가깝다고 느낀다.", axis: "SN", side: "N" },

  { id: "SN_S5", text: "기도할 때 지금 처한 상황과 필요를 하나씩 구체적으로 이야기하는 편이다.", axis: "SN", side: "S" },
  { id: "SN_N5", text: "기도할 때 말로 정리되지 않은 마음을 그대로 올려드리게 되는 편이다.", axis: "SN", side: "N" },

  // T / F — 무엇을 기준으로 판단하는가
  { id: "TF_T1", text: "힘들다는 이야기를 들으면 어떻게 하면 나아질지부터 생각하게 된다.", axis: "TF", side: "T" },
  { id: "TF_F1", text: "힘들다는 이야기를 들으면 그 마음이 어땠을지부터 마음에 걸린다.", axis: "TF", side: "F" },

  { id: "TF_T2", text: "교회에서 어떤 결정이 내려지면 그 이유가 납득되는지가 중요하다.", axis: "TF", side: "T" },
  { id: "TF_F2", text: "교회에서 어떤 결정이 내려지면 그 일로 속상한 사람이 없는지가 신경 쓰인다.", axis: "TF", side: "F" },

  { id: "TF_T3", text: "설교나 신앙 서적에서 앞뒤가 맞지 않는 이야기가 나오면 그 부분이 계속 걸린다.", axis: "TF", side: "T" },
  { id: "TF_F3", text: "설교나 신앙 서적이 마음을 울리면 세세한 내용은 크게 따지지 않게 된다.", axis: "TF", side: "F" },

  { id: "TF_T4", text: "신앙에 의문이 들 때 납득할 만한 설명이나 근거를 찾아보게 된다.", axis: "TF", side: "T" },
  { id: "TF_F4", text: "신앙에 의문이 들 때 누군가의 진솔한 이야기나 경험에 마음이 열린다.", axis: "TF", side: "F" },

  { id: "TF_T5", text: "부탁을 받으면 내가 할 수 있는 일인지 현실적으로 먼저 따져본다.", axis: "TF", side: "T" },
  { id: "TF_F5", text: "부탁을 받으면 거절했을 때 상대가 어떻게 느낄지가 먼저 떠오른다.", axis: "TF", side: "F" },

  // J / P — 삶을 어떤 방식으로 꾸려 가는가
  { id: "JP_J1", text: "기도나 성경 읽기는 시간을 정해두는 편이 나에게 잘 맞는다.", axis: "JP", side: "J" },
  { id: "JP_P1", text: "기도나 성경 읽기는 마음이 생길 때 하는 편이 나에게 잘 맞는다.", axis: "JP", side: "P" },

  { id: "JP_J2", text: "주일 하루가 대략 정해진 순서대로 흘러가는 편이 마음이 편하다.", axis: "JP", side: "J" },
  { id: "JP_P2", text: "주일 하루가 그날 상황에 따라 달라져도 별로 불편하지 않다.", axis: "JP", side: "P" },

  { id: "JP_J3", text: "무언가 해보기로 마음먹으면 언제 어떻게 할지 정해둬야 마음이 놓인다.", axis: "JP", side: "J" },
  { id: "JP_P3", text: "무언가 해보기로 마음먹어도 상황을 봐 가며 조절하는 편이 마음이 편하다.", axis: "JP", side: "P" },

  { id: "JP_J4", text: "약속이나 일정이 갑자기 바뀌면 마음을 다시 잡는 데 시간이 좀 걸린다.", axis: "JP", side: "J" },
  { id: "JP_P4", text: "약속이나 일정이 갑자기 바뀌어도 ‘그럴 수도 있지’ 하고 금방 넘어간다.", axis: "JP", side: "P" },

  { id: "JP_J5", text: "지난 시간을 돌아볼 때 마음먹은 것을 얼마나 지켰는지 살펴보게 된다.", axis: "JP", side: "J" },
  { id: "JP_P5", text: "지난 시간을 돌아볼 때 어떤 일들을 겪고 지나왔는지 떠올려 보게 된다.", axis: "JP", side: "P" },
]);
