...
디자인·기능뿐 아니라 **40문항과 16유형 결과 분석, 블로그 글까지 원본 내용 그대로** 들어 있습니다.
...
두 사이트에 같은 문구가 그대로 올라가므로, 구글은 둘 중 하나만 검색 결과에 남기고
나머지는 중복으로 걸러낼 수 있습니다. 두 사이트 모두 검색 유입이 필요하다면
`data.js`의 문항·결과 텍스트와 `blog/` 글을 이 저장소 쪽에서 새로 쓰는 편이 좋습니다.
